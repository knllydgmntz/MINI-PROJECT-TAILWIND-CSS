        ...
        <div className="flex flex-col my-6 space-y-6 md:space-y-0 md:space-x-6 md:flex-row md:my-0">
          ...
          <div className="bg-slate-700 rounded-xl text-white">
            ...
            <div className="p-8 mx-3 mt-3 rounded-t-xl bg-slate-800">
              ...
              <h3 className="mt-2 text-center">$1.00/Month</h3>
          ...
          <div className="bg-violet-600 rounded-xl text-white">
            ...
            <div className="p-8 mx-3 mt-3 rounded-t-xl bg-slate-800">
              ...
              <div className="flex justify-center">
                <a
                  className="inline-block px-10 py-3 my-6 text-center border border-violet-600 rounded-lg hover:bg-violet-800 hover:border-violet-800 duration-200 bg-violet-600"
                  href="#"
                >
                  Purchase
                </a>
            ...
            <div className="p-8 mx-3 mb-3 rounded-b-xl bg-slate-800">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <div className="flex justify-center">
                  ...
                  <span className="text-sm ml-1">200 GB storage</span>
                </div>
                {/* List Item 2 */}
                <div className="flex justify-center">
                  <svg
            ...
            <div className="p-8 mx-3 mb-3 rounded-b-xl bg-slate-800">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <div className="flex justify-center">
                  ...
                  <span className="text-sm ml-1">2 TB storage</span>
                </div>
                {/* List Item 2 */}
                <div className="flex justify-center">
                  <svg
