import ImageHeadphone from "../assets/images/headphone.png";
import ImageWeight from "../assets/images/weight.png";
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center min-h-screen bg-slate-100">
        {/* Card Container */}
        <div className="flex flex-col p-6 m-3 space-y-10 bg-white rounded-2xl shadow-2xl md:flex-row md:space-y-0 md:space-x-10 md:-0 md:p-16">
          {/* Image */}
          <div>
            <img
            ...
            <div className="flex flex-col mb-4 space-y-3 text-center md:text-left">
              ...
              <div className="flex flex-col mb-4 space-y-3 text-center md:text-left">
                ...
                <p className="text-sm font-white text-gray-400">
                  This offer is valid until May 3rd or as long as stock lasts!
                </p>
              </div>

              {/* Button Group */}
              <div className="group">
                <button className="w-full transition-all duration-150 bg-blue-700 text-white  border-b-blue-700 rounded-lg group-hover:bg-blue-700 group-hover:border-t-blue-700 group-hover:shadow-lg">
              ...
              <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-4 md:flex-row">
                <button className="flex items-center justify-center py-3 px-5 space-x-3 border-2 border-gray-300 rounded-lg shadow-sm hover:bg-opacity-30 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-150">
                  <img className="w-8" src={ImageWeight} alt="Weight Image" />
                  <span>Add to cart</span>
                </button>

                <button className="flex items-center justify-center py-3 px-5 space-x-3 border-2 border-gray-300 rounded-lg shadow-sm hover:bg-opacity-30 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-150">
                  <img className="w-8" src={ImageHeart} alt="Heart Image" />
